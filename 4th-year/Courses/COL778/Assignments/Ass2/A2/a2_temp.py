...
class environment:
    ...
    def plot(self,policy, value, move_map,cmap = 'plasma', figsize = None, show_values = True, show_policy = True, save_path = None):
...
if __name__ == "__main__":
    ...
    small_MDP = MDPSolver(small_environment, 0.9)
    VI_pol, VI_val, VI_hist = small_MDP.value_iteration(print_iters = True, tol = tol)
    small_environment.plot(VI_pol,VI_val,move_map,cmap = 'hsv',show_values = True, show_policy = True, save_path = f'plots/partb1_petrol_1.png', figsize=None)
    
    living_reward = -0.9
    small_environment = environment('small_map.csv', move_list, move_move_map,p = p,living_reward = living_reward, hole_reward = hole_reward, goal_reward = goal_reward)
    small_MDP = MDPSolver(small_environment, 0.9)
    VI_pol, VI_val, VI_hist = small_MDP.value_iteration(print_iters = True, tol = tol)
    small_environment.plot(VI_pol,VI_val,move_map,cmap = 'Wistia',show_values = True, show_policy = True, save_path = f'plots/partb1_petrol_2.png', figsize=None)
